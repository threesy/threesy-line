        ...
        createClass(ThreesyLine, [{
            ...
            value: function draw() {
                ...
                if (typeof this._domainY === "undefined") {
                    var _domain = extent(this._data, function (d) {
                ...
                this._scaleX = point$2().domain(this._domainX).range([0, this._width]);

                this._scaleY = linear().domain(this._domainY).range([this._height, 0]);

                this._axisX = axisBottom(this._scaleX);

                this._axisY = axisLeft(this._scaleY).ticks(this._data.length);
